...
import (
	...
	"github.com/gochain-io/gochain/p2p/protocols"
	...
	"github.com/gochain-io/gochain/swarm/fuse"
	"github.com/gochain-io/gochain/swarm/log"
	"github.com/gochain-io/gochain/swarm/network"
	"github.com/gochain-io/gochain/swarm/network/stream"
	"github.com/gochain-io/gochain/swarm/pss"
	"github.com/gochain-io/gochain/swarm/state"
	"github.com/gochain-io/gochain/swarm/storage"
	"github.com/gochain-io/gochain/swarm/storage/feed"
	"github.com/gochain-io/gochain/swarm/storage/mock"
	"github.com/gochain-io/gochain/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	if config.SwapAPI != "" && config.SwapEnabled {
		...
		backend, err = goclient.Dial(config.SwapAPI)
		if err != nil {
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config, privkey *ecdsa.PrivateKey) (*ensClient, error) {
	...
	ethClient := goclient.NewClient(client)
