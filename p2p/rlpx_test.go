...
func testEncHandshake(token []byte) error {
	...
	go func() {
		...
		r.pubkey, r.err = c0.doEncHandshake(context.Background(), prv0, &prv1.PublicKey)
		if r.err != nil {
			return
		}
	...
	go func() {
		...
		r.pubkey, r.err = c1.doEncHandshake(context.Background(), prv1, nil)
		if r.err != nil {
			return
		}
...
func TestProtocolHandshake(t *testing.T) {
	...
	go func() {
		...
		defer fd1.Close()
		rlpx := newRLPX(fd0)
		rpubkey, err := rlpx.doEncHandshake(context.Background(), prv0, &prv1.PublicKey)
		if err != nil {
	...
	go func() {
		...
		defer fd1.Close()
		rlpx := newRLPX(fd1)
		rpubkey, err := rlpx.doEncHandshake(context.Background(), prv1, nil)
		if err != nil {
