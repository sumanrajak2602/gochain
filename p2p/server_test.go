...
import (
	...
	"github.com/gochain-io/gochain/p2p/enr"
)
...
func (c *testTransport) doEncHandshake(ctx context.Context, prv *ecdsa.PrivateKey, dialDest *ecdsa.PublicKey) (*ecdsa.PublicKey, error) {
	return c.rpub, nil
}
...
func (c *setupTransport) doEncHandshake(ctx context.Context, prv *ecdsa.PrivateKey, dialDest *ecdsa.PublicKey) (*ecdsa.PublicKey, error) {
