...
type Config struct {
	...
	NoDiscovery bool `toml:",omitempty"`
...
type transport interface {
	// The two handshakes.
	doEncHandshake(ctx context.Context, prv *ecdsa.PrivateKey, dialDest *ecdsa.PublicKey) (*ecdsa.PublicKey, error)
...
func (srv *Server) setupConn(ctx context.Context, c *conn, flags connFlag, dialDest *enode.Node) error {
	...
	remotePubkey, err := c.doEncHandshake(ctx, srv.PrivateKey, dialPubkey)
	if err != nil {
